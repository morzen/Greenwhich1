...
try:
    while True:
        ...
        if os.path.isdir(root_path):
            index_and_search(root_path, len(root_path) + 1, search_string.lower())
            index_and_search(root_path, len(root_path) + 1, search_string.upper())
            index_and_search(root_path, len(root_path) + 1, search_string.title())
